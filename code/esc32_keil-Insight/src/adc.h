...
#define ADC_SAMPLE_TIME	ADC_SampleTime_239Cycles5//ADC_SampleTime_28Cycles5
...
#define ADC_THRESHOLD_VALUE 250//value for stop tripod
...
extern void adcTimerAction(void);
